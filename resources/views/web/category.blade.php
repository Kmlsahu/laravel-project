...
@section('title')
    <title>ThewayShop | {{ $category->name }}</title>
@endsection
                                    ...
                                    @foreach (Category() as $key => $categories)
                                        <div class="list-group-collapse sub-men">
                                            <a class="list-group-item list-group-item-action" href="#sub-men1"
                                                ...
                                                aria-controls="sub-men1">{{ $categories->name }} <small
                                                    class="text-muted">(100)</small>
                                            </a>
                                            <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                                <div class="list-group">
                                                    @foreach (SubCategory($categories->id) as $subcat)
                                                        <a href="{{ route('category', $subcat->url_key) }}"
                                                            class="list-group-item list-group-item-action active">{{ $subcat->name }}
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                <div class="products-single fix">
                                                    <div class="box-img-hover">
                                                        ...
                                                        <img src="{{ $product->getFirstMediaUrl('thumbnail_image') }}"
                                        ...
                                        @foreach ($category->products as $_product)
                                            <div class="row">
                                                <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                                    <div class="products-single fix">
                                                        <div class="box-img-hover">
                                                            ...
                                                            <img src="{{ $_product->getFirstMediaUrl('thumbnail_image') }}"
                                                                class="img-fluid" alt="Image">
                                                            <div class="mask-icon">
                                                                <ul>
                                                                    <li><a href="{{ route('product', $_product->url_key) }}"
                                                                            data-toggle="tooltip" data-placement="right"
                                                ...
                                                <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                    <div class="why-text full-width">
                                                        <h4><a href="{{ route('product', $_product->url_key) }}" style="text-decoration: none; color: inherit;">{{ $_product->name }}</a></h4>
                                                        <h5> <del>₹ {{ $_product->price }}</del>
                                                            ₹{{ $_product->special_price }}</h5>
                                                        <p>{!! $_product->description !!}</p>
                                                        <a class="btn hvr-hover" href="{{ route('product', $_product->url_key) }}">Add to Cart</a>
                                                    </div>
                                                </div>
                                            </div> <br>
                                        @endforeach
